...
# Simple Python version of a Flash/ActionScript "app" I first did in 2003: http://www.ms-studio.com/Animation/pangrammerhelper.html

# Purpose is to help you write pangrams--sentences that contain all the letters of the alphabet.

# Type in the window. The alphabet will shrink as you use up the letters. Current pangram length displayed at bottom.
# If you have a Space Center window open, its current text will be used and updated as you compose your pangram.

# Note: It doesn't do anything with spelled out glyph names (e.g., "/space" or "/exclam"). 
...
class PangrammerHelper(object):
    ...
    def __init__(self):
        ...
        if CurrentSpaceCenter() is None:
            ...
            pangram = sp.getRaw()
        self.w.pangramEditor = vanilla.TextEditor((15, 40, -15, 70), pangram, callback=self.textEditorCallback)
        self.w.counter = vanilla.TextBox((-250, 110, -15, 20), "Pangram length: 0", alignment='right')
        self.w.checkBox = vanilla.CheckBox((15, 110, -15, 20), "Mixed case", callback=self.checkBoxCallback, value=True)
        self.w.open()
    ...
    def checkBoxCallback(self, sender):
        ...
        self.w.alphabet.set(self.getRemainingLetters(self.w.pangramEditor.get()))
